        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Link href={item.href}>
                <button
                  className={`flex items-center justify-center w-14 h-14 rounded-full transition-all duration-300 group ${
                    isActive 
              ...
              {/* Tooltip */}
              <div
                className={`absolute right-16 top-1/2 -translate-y-1/2 px-4 py-2 rounded-lg text-sm whitespace-nowrap transition-opacity duration-300
