            ...
            <div className="space-y-8 scroll-reveal">
              <div className="space-y-4">
                <h1 className="font-heading text-5xl lg:text-7xl font-bold leading-tight">
                  <span className="block text-cyanPrimary">{(import.meta.env.VITE_HERO_TITLE_1) || "Creative"}</span>
                  <span className="block gradient-text">{(import.meta.env.VITE_HERO_TITLE_2) || "Developer"}</span>
                </h1>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <div className="flex gap-4">
                  ...
                  {!(import.meta.env.VITE_GITHUB_URL) && !(import.meta.env.VITE_LINKEDIN_URL) && !(import.meta.env.VITE_TWITTER_URL) && (
                    <p className="text-cyanPrimary/50 text-sm">Add social links via environment variables</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center scroll-reveal">
              ...
              <div className="w-full max-w-md lg:max-w-lg mx-auto">
                {(import.meta.env.VITE_HERO_IMAGE) ? (
                  ...
                  <div className="w-full h-64 lg:h-80 bg-gradient-to-br from-cyanPrimary/20 to-purpleAccent/20 rounded-3xl shadow-2xl animate-float flex items-center justify-center">
                    <p className="text-cyanPrimary/50 text-center px-4">Add VITE_HERO_IMAGE<br />to display your image</p>
                  </div>
                )}
              </div>
