    ...
    <>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 scroll-reveal">
              <div className="space-y-4">
                <h1 className="font-heading text-5xl lg:text-7xl font-bold leading-tight">
                  <span className="block text-softNavy">Creative</span>
                  <span className="block gradient-text">Developer</span>
                </h1>
                <p className="text-xl lg:text-2xl text-softNavy/80 font-light leading-relaxed">
                  Crafting immersive digital experiences with cutting-edge technology and thoughtful design.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/projects">
                  <Button 
                    className="bg-warmOrange hover:bg-warmOrange-600 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-2xl w-full sm:w-auto"
                ...
                <Link href="/chat">
                  <Button 
                    variant="outline"
                    className="border-2 border-calmBlue text-calmBlue hover:bg-calmBlue hover:text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 w-full sm:w-auto"
              ...
              <div className="flex gap-4 pt-4">
                <a 
                  ...
                  className="w-12 h-12 rounded-full glass-effect flex items-center justify-center hover:scale-110 transition-all duration-300 hover:bg-white/30"
                  data-testid="link-github"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Github className="w-5 h-5 text-softNavy" />
                </a>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <Linkedin className="w-5 h-5 text-softNavy" />
                </a>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <Twitter className="w-5 h-5 text-softNavy" />
                </a>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center scroll-reveal">
              <img 
                src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=800" 
                alt="Modern developer workspace with multiple monitors showing code" 
                className="rounded-3xl shadow-2xl w-full max-w-md lg:max-w-lg animate-float"
              />
              
              {/* Floating Tech Icons */}
              <div className="absolute -top-4 -left-4 w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg animate-bounce-slow">
                <svg className="w-8 h-8 text-calmBlue" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg animate-pulse-slow">
              ...
              <div className="absolute top-1/2 -right-8 w-12 h-12 bg-white/90 rounded-full flex items-center justify-center shadow-lg animate-float">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-softNavy/30 rounded-full flex justify-center">
            <div className="w-1 h-3 bg-softNavy/60 rounded-full mt-2 animate-pulse"></div>
          </div>
        </div>
      </section>
    </>
